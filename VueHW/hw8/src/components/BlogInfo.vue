<template>
  <section class="blog_details_description">
    <h1 class="blog_details_description__title">
      {{ news[detailedBlog - 1].title }}
    </h1>
    <img
      class="blog_details_description__titleImg"
      src="../assets/blog_photo1.png"
      alt="blog_photo"
    />

    <div class="blog_details_description_info">
      <p class="blog_details_description_info__date">
        {{ news[detailedBlog - 1].date }}
      </p>
      <p class="blog_details_description_info__bread">
        Interior / Home / Decore
      </p>
    </div>

    <p class="blog_details_description__text">
    ...
    <article class="blog_details_description_quote">
      <span class="blog_details_description_quote__symbol"
        ><svg
          width="74"
          height="56"
          viewBox="0 0 74 56"
      ...
      <p class="blog_details_description_quote__text">
    ...
    <ul class="blog_details_description__list">
      <li class="blog_details_description__list__item">
        <span class="blog_details_description__list__item__number">1</span
        >Contrary to popular belief.There are many variations of passages of
        Lorem Ipsum available, but the majority have suffered.
      </li>

      <li class="blog_details_description__list__item">
        <span class="blog_details_description__list__item__number">2</span
        >Contrary to popular belief.There are many variations of passages of
        Lorem Ipsum available, but the majority have suffered.
      </li>

      <li class="blog_details_description__list__item">
        <span class="blog_details_description__list__item__number">3</span
        >Contrary to popular belief.There are many variations of passages of
        Lorem Ipsum available, but the majority have suffered.
      </li>
    </ul>
    ...
    <img
      class="blog_details_description__subtitleImg"
      src="../assets/blog_photo2.png"
      alt="blog_photo"
    />
