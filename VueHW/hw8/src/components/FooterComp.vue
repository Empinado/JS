  ...
  <footer class="footer center">
    <div class="footer_main">
      <router-link to="/main" class="footer_main__link">
        <img
          class="footer_main__link__logo logo"
          src="../assets/logo.svg"
          alt="Logo"
        />
      </router-link>
      ...
      <div class="footer_main_socials">
        <a class="footer_main_socials__twitter" href="#"
          ><svg
            width="19"
            height="16"
            viewBox="0 0 19 16"
        ...
        <a class="footer_main_socials__instagram" href="#"
          ><svg
            width="17"
            height="16"
            viewBox="0 0 17 16"
    ...
    <div class="footer_pages">
      ...
      <router-link to="/our_projects" class="footer_pages__link"
        >Project</router-link
      >
