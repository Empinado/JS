    ...
    <div class="details center">
      <div class="details_description">
        ...
        <p class="details_description__text">
          ...
          in mi fringilla mattis. Phasellus ut dolor odio. Aenean in the ipsum
      ...
      <div class="details_view">
        <div class="details_view_slide">
          <img
            class="details_view_slide__img"
            :src="require(`@/assets/${projects[slide].img}`)"
            alt=""
          />
          <svg
            class="details_view_slide__zoom"
            width="172"
            height="172"
            viewBox="0 0 172 172"
            fill="none"
...
.details_view_slide__img {
  width: 1200px;
  height: 800px;
  border-radius: 70px;
}
.details_view_slide__zoom {
  position: absolute;
  left: 42%;
  top: 42%;
}
.details_view_slide__zoom:hover {
  cursor: pointer;
}
.details_view_numbers {
  display: flex;
  gap: 10px;
  padding-top: 20px;
  justify-content: center;
}
.details_view_numbers__number {
  width: 40px;
  height: 40px;
  border-radius: 50%;
...
.details_view_numbers__number:hover {
  cursor: pointer;
}
.current {
  background: #cda274;
