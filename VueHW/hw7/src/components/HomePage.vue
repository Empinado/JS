<template>
  <div class="home-page">
    ...
    <div class="main center">
      <div class="main__top">
        <h2 class="main__title">Follow Our Projects</h2>
        <p class="main__text">
      ...
      <div class="news__container">
        <div class="news__item">
          ...
          <div class="news__item_btm">
            <h2 class="news__item_btm_title">
              Let’s Get Solution<br />
              For Building Construction<br />Work
            </h2>
